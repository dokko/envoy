...
apt install php8.1-fpm php8.1-mysql php8.1-mbstring php8.1-xml php8.1-bcmath
...
sed -i "s/expose_php = .*/expose_php = Off/" /etc/php/8.1/cli/php.ini
# Commented out because out-of-box value is already confitured for production.
# sed -i "s/error_reporting = .*/error_reporting = E_ALL & ~E_DEPRECATED & ~E_STRICT/" /etc/php/8.1/cli/php.ini
sed -i "s/display_errors = .*/display_errors = Off/" /etc/php/8.1/cli/php.ini
